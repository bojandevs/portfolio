...
export const metadata: Metadata = {
	title: 'Bojan Stojanov - Developer',
	description:
	...
	authors: [{ name: 'Bojan Stojanov' }],
	creator: 'Bojan Stojanov',
	openGraph: {
		title: 'Bojan Stojanov - Developer Portfolio',
		description: 'Passionate developer creating simple and effective solutions. Explore my projects and development approach.',
		url: 'https://bojanstojanov.com',
		siteName: 'Bojan Stojanov - Portfolio',
		images: [
			{
				url: '/og-image.jpg',
				width: 1200,
				height: 630,
				alt: 'Bojan Stojanov - Developer Portfolio',
			},
		],
		locale: 'en_US',
		type: 'website',
