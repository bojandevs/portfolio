	...
	const experiences = [
		{
			...
			company: 'University of Primorska (FAMNIT)',
			period: '2023 – Present',
			highlights:
				'Focused on programming fundamentals, algorithms, databases, and web development using Java, Python, C, and MySQL.',
		},
		{
			...
			period: '2025 - Present',
			highlights:
				'Worked with clients on small-scale web development projects, building responsive websites using HTML, CSS, and JavaScript. Focused on clean design, performance, and client satisfaction.',
		},
	];
